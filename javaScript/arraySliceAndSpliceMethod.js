...
console.log("Sliced Array: " + slicedArr); // Output: [30, 40, 50]
...
console.log("Spliced Array (Removed Elements): " + splicedArr); // Output: [30, 40, 50] -> splice returns the removed elements
...
console.log("Spliced Array (After Adding Elements): " + arr); // Output: [10, 20, 35, 45, 60, 70, 80, 90]

// iii] Replacing elements
arr.splice(4, 2, 65, 75); // Replaces 2 elements at index 4 with 65 and 75
console.log("Spliced Array (After Replacing Elements): " + arr); // Output: [10, 20, 35, 45, 65, 75, 80, 90]
